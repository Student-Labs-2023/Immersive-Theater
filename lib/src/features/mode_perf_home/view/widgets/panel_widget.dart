...
class HomeModePanelWidget extends StatefulWidget {
  ...
  @override
  State<HomeModePanelWidget> createState() => _HomeModePanelWidgetState();
}

class _HomeModePanelWidgetState extends State<HomeModePanelWidget> {
  @override
    ...
    return Column(
      ...
      children: [
        ...
        AnimatedVisibility(
          ...
          curve: Curves.easeIn,
          child: BlocBuilder<PerfHomeModeBloc, PerfHomeModeState>(
        ...
        BlocBuilder<PerfHomeModeBloc, PerfHomeModeState>(
          builder: (context, state) {
